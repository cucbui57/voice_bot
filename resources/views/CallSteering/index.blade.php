@extends('template')
@include('CallSteering.particials.common')
            ...
            <div class="col-md-12">
                <div class="portlet box blue-soft">
                    ...
                    <div class="col-md-12 portlet-body" style="border: 1px solid  #4c87b9; margin-bottom: 10px">
                        ...
                        <div class="col-md-6 portlet-body" id="hight_chart">
    
                        </div>
                        {{--  <div class="col-md-1 portlet-body">
    
                        </div>  --}}
                        <div class="col-md-6 portlet-body" style="margin-top: 2px" id="line_chart">
