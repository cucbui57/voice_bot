@extends('template')
@include('AutoOrder.particials.common')
            ...
            <div class="col-md-12">
                <div class="portlet box blue-soft">
                    ...
                    <div class="col-md-12 portlet-body" style="border: 1px solid  #4c87b9; margin-bottom: 10px">
                        ...
                        <div class="col-md-6 portlet-body" id="hight_chart_total_time">
    
                        </div>
                        <div class="col-md-6 portlet-body" id="hight_chart_order">
    
                        </div>
                        <div class="col-md-6 portlet-body" id="hight_chart_confirm_order">
