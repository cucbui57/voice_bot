...
var AppReview = function () {
    ...
    var _loadDataHightChart_total_time = function () {
        ...
        var dateRange = jQuery('#chosen-time-range').data('daterangepicker');
        $.ajax({
            url: baseUrl + '/CustomerCare/getHightChart',
            type: 'POST',
            dataType: 'json',
            data: {
                // startDate: dateRange.startDate.valueOf(),
            ...
            beforeSend: function () {
                App.blockUI({
                    ...
                    target: jQuery('#hight_chart_satisfaction'),
                    boxed: true
                });
            },
            complete: function () {
                ...
                App.unblockUI(jQuery('#hight_chart_satisfaction'));
            ...
            success: function (data) {
                ...
                _drawChart_satisfaction('#hight_chart_satisfaction', data[2]);
            }
        })
    }
    ...
    var _drawChart_satisfaction = function (element, data) {
        jQuery(element).highcharts({
            chart: {
                plotBackgroundColor: null,
                plotBorderWidth: 0,
