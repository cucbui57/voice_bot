...
var AppReview = function () {
    ...
    var _loadDataHightChart_total_time = function () {
        ...
        var dateRange = jQuery('#chosen-time-range').data('daterangepicker');
        $.ajax({
            url: baseUrl + '/TeleSale/getHightChart',
            type: 'POST',
            dataType: 'json',
            data: {
                // startDate: dateRange.startDate.valueOf(),
            ...
            beforeSend: function () {
                App.blockUI({
                    ...
                    target: jQuery('#hight_chart_call_back'),
                    target: jQuery('#hight_chart_feedback'),
                    boxed: true
                });
            },
            complete: function () {
                ...
                App.unblockUI(jQuery('#hight_chart_call_back'));
                App.unblockUI(jQuery('#hight_chart_feedback'));
            ...
            success: function (data) {
                ...
                _drawChart_total_call_back('#hight_chart_call_back', data[2]);
                _drawChart_total_feedback('#hight_chart_feedback', data[3]);
            }
        })
    }
    ...
    var _drawChart_total_call_back = function (element, data) {
        jQuery(element).highcharts({
            chart: {
                plotBackgroundColor: null,
                plotBorderWidth: 0,
    ...
    var _drawChart_total_feedback = function (element, data) {
        jQuery(element).highcharts({
            chart: {
                plotBackgroundColor: null,
                plotBorderWidth: 0,
